...
const translations: Translation[] = [
  ...
  { de: 'Audio-Test', en: 'Audio test' },
  { de: 'Testseite', en: 'Test page' },
  { de: 'Sprachnachricht aufnehmen', en: 'Record voice message' },
  { de: 'Nimm hier eine kurze Nachricht auf, hör sie lokal an und schicke sie dann als testweise `latest.wav` an das NFC-Gerät.', en: 'Record a short message here, listen locally, then send it as a test `latest.wav` to the NFC device.' },
  { de: 'Aufnahme starten', en: 'Start recording' },
  { de: 'Stop', en: 'Stop' },
  { de: 'Zurücksetzen', en: 'Reset' },
  { de: 'Dauer:', en: 'Duration:' },
  { de: 'Lokale Vorschau', en: 'Local preview' },
  { de: 'An Gerät senden', en: 'Send to device' },
  { de: 'Serverstatus', en: 'Server status' },
  { de: 'Zuletzt hochgeladene Testdatei', en: 'Last uploaded test file' },
  { de: 'Noch keine Datei hochgeladen.', en: 'No file uploaded yet.' },
  { de: 'Testablauf', en: 'Test flow' },
  { de: 'Seite öffnen und kurz aufnehmen.', en: 'Open the page and record briefly.' },
  { de: 'Mit "An Gerät senden" hochladen.', en: 'Upload with "Send to device".' },
  { de: 'ESP32 pollt die Test-API und spielt die neueste WAV-Datei ab.', en: 'ESP32 polls the test API and plays the newest WAV file.' },
