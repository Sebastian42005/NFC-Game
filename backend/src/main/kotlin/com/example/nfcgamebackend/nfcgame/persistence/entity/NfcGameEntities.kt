package com.example.nfcgamebackend.nfcgame.persistence.entity

import com.example.nfcgamebackend.nfcgame.domain.AdminRole
...
import com.example.nfcgamebackend.nfcgame.domain.WinRuleType
...
@Table(
    name = "nfc_sound",
    indexes = [
        Index(name = "idx_nfc_sound_account", columnList = "account_id"),
        Index(name = "idx_nfc_sound_publication", columnList = "publication_status,active"),
    ],
)
class NfcSound : NfcUuidEntity() {
    @Column(nullable = false)
    var name: String = ""
    ...
    @Column(name = "source_sound_id")
    var sourceSoundId: UUID? = null

    @Column(columnDefinition = "bytea")
    var wavContent: ByteArray? = null
...
@Entity
@Table(
    name = "nfc_sound_rating",
    indexes = [
        Index(name = "idx_nfc_sound_rating_sound", columnList = "sound_id"),
        Index(name = "idx_nfc_sound_rating_account", columnList = "account_id"),
    ],
    uniqueConstraints = [
        UniqueConstraint(name = "uk_nfc_sound_rating_sound_account", columnNames = ["sound_id", "account_id"]),
    ],
)
class NfcSoundRating : NfcUuidEntity() {
...
@Entity
@Table(
    name = "nfc_device_sound_command",
    indexes = [
        Index(name = "idx_nfc_device_sound_command_device", columnList = "device_id"),
        Index(name = "idx_nfc_device_sound_command_session", columnList = "session_id"),
    ],
)
class NfcDeviceSoundCommand : NfcUuidEntity() {
