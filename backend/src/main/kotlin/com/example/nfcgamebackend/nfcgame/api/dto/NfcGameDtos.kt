package com.example.nfcgamebackend.nfcgame.api.dto
...
data class SoundUpdateRequest(
    @field:NotBlank val name: String,
)

data class SoundRatingRequest(
    @field:Min(-1) @field:Max(1) val rating: Int,
)

data class DeviceSoundMetadataResponse(
...
data class DeviceSoundAckRequest(
    val version: Long,
)
