package com.example.nfcgamebackend.nfcgame.persistence.repository
...
import com.example.nfcgamebackend.nfcgame.persistence.entity.NfcFlowDefinition
import com.example.nfcgamebackend.nfcgame.persistence.entity.NfcFlowEdge
...
import com.example.nfcgamebackend.nfcgame.persistence.entity.NfcPlayerStatsProjection
...
interface NfcSoundRepository : JpaRepository<NfcSound, UUID> {
    fun findAllByAccountIdAndActiveTrueOrderByUpdatedAtDesc(accountId: Long): List<NfcSound>
    fun findAllByAccountIdAndActiveTrueOrderByNameAsc(accountId: Long): List<NfcSound>
    fun findAllByPublicationStatusAndActiveTrueOrderByUpdatedAtDesc(status: GamePublicationStatus): List<NfcSound>
    fun deleteAllByAccountId(accountId: Long)
}

interface NfcSoundRatingRepository : JpaRepository<NfcSoundRating, UUID> {
    fun findBySoundIdAndAccountId(soundId: UUID, accountId: Long): NfcSoundRating?
    fun countBySoundIdAndRating(soundId: UUID, rating: Int): Long
    fun deleteBySoundIdAndAccountId(soundId: UUID, accountId: Long)
}
