...
import com.example.nfcgamebackend.nfcgame.api.dto.FlowDefinitionResponse
import com.example.nfcgamebackend.nfcgame.api.dto.FlowStateResponse
import com.example.nfcgamebackend.nfcgame.api.dto.FlowTransitionResponse
import com.example.nfcgamebackend.nfcgame.api.dto.GameTemplateRequest
...
class NfcAdminService(
    ...
    private fun currentUser(): com.example.nfcgamebackend.security.AuthenticatedUser {
        val principal = SecurityContextHolder.getContext().authentication?.principal
        if (principal is com.example.nfcgamebackend.security.AuthenticatedUser) {
            return principal
        }
