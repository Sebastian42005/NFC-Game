package com.example.nfcgamebackend.nfcgame.application.publicapi
...
import com.example.nfcgamebackend.nfcgame.api.dto.SessionRoundResponse
import com.example.nfcgamebackend.nfcgame.api.dto.TeamMemberResponse
import com.example.nfcgamebackend.nfcgame.api.dto.TeamResponse
...
import com.example.nfcgamebackend.nfcgame.persistence.repository.NfcPlayerStatsProjectionRepository
...
class NfcPublicQueryService(
    ...
    private fun playerImageUrl(player: com.example.nfcgamebackend.nfcgame.persistence.entity.NfcPlayer): String? =
        player.imageContentType?.let { "/api/public/players/${player.id}/image" } ?: player.imageUrl

    private fun gameImageUrl(template: com.example.nfcgamebackend.nfcgame.persistence.entity.NfcGameTemplate?): String? =
